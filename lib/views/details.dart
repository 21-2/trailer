          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                decoration: BoxDecoration(boxShadow: [BoxShadow(color: Colors.grey.shade200, spreadRadius: 5, blurRadius: 5, offset: Offset(2,6))]),
                  child: ElevatedButton(
                    onPressed: ()=>{}, child: Text('장바구니에 담기', style: TextStyle(color: Colors.white, fontSize: 15)), 
                    style: ButtonStyle(
                      fixedSize: MaterialStateProperty.all(Size.fromWidth(width*0.4)),
            ...
            child: Stack(
              ...
              Positioned(
                ...
                child: Column(
                  ...
                  children: [
                    Text('이스케이프 풀 빌라', style: TextStyle(fontWeight: FontWeight.w700, fontSize:20, color: Colors.white)),
                    Row(
                      children:[
                      heart,
                      Text('1100', style:TextStyle(fontSize: 15, color: Colors.white ))
                    ])
                  ],
                )),
              ]
            ...
            children: [
              Row(children: [
                ...
                Padding(
                  ...
                  child: Text('경상북도 포항시 북구 한동로 55B',),
                )
              ],),
              Row(children: [
